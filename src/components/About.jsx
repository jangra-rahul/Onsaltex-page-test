    ...
    <>
      <section className="bg_theme py-5">
        <Container>
          ...
          <div className="row d-sm-flex d-none position-relative z_index_1 mt-5">
            <div className="col-md-3 col-sm-6">
              <div className=" box_card text-center">
                <div className="position-relative">
                  {" "}
                  <svg
                    className="svg_hover mb-3"
                    width="76"
                    height="75"
                    viewBox="0 0 76 75"
                    fill="none"
                  ...
                  <img
                    className=" d-sm-block d-none position-absolute left_arrow_line"
                    src={right_arrow}
                    alt="right_arrow"
                  />
                </div>

                <h2 className="fs_xsm mt-1 text-white ff_mont fw_semibold">
                  1. Terminanfrage
                </h2>
                <p className=" fs_xsm mt-2 mb-0 fw_regular ff_mont text_primary_color">
                  Vereinbare online deinen Termin und beantworte einige Fragen,
                  damit wir uns optimal auf dich vorbereiten können Termin und
            ...
            <div className="col-md-3 col-sm-6">
              <div className=" box_card text-center">
                <div className="position-relative">
                  ...
                  <img
                    className=" d-md-block d-none position-absolute d-md-flex d-none left_arrow_line"
                    src={right_arrow}
                    alt="right_arrow"
                  />
                </div>

                <h2 className="fs_xsm mt-3 text-white ff_mont fw_semibold">
                  2. Erstgespräch
                </h2>
                <p className=" fs_xsm mt-2 mb-0 fw_regular ff_mont text_primary_color">
            ...
            <div className="col-md-3 mt-4 mt-md-0 col-sm-6">
              <div className=" box_card text-center">
                <div className="position-relative">
                  <svg
                    className="mb-3 svg_hover"
                    width="76"
                    height="75"
                    viewBox="0 0 76 75"
                    fill="none"
                ...
                <h2 className="fs_xsm mt-2 text-white ff_mont fw_semibold">
                  3. Strategieberatung
                </h2>
                <p className=" fs_xsm mt-2 mb-0 fw_regular ff_mont text_primary_color">
          ...
          <Carousel className="d-sm-none d-flex mt-3">
            <Carousel.Item>
              <div className="col-md-3 col-sm-6">
                <div className=" box_card text-center">
                  <div className="position-relative">
                    ...
                    {/* <img
                      className=" position-absolute left_arrow_line"
                      src={right_arrow}
                      alt="right_arrow"
                    /> */}
                  </div>
            ...
            <Carousel.Item>
              ...
              <div className="col-md-3 col-sm-6">
                <div className=" box_card text-center">
                  ...
                  <p className=" fs_xsm mt-2 mb-0 fw_regular ff_mont text_primary_color">
                    Im Telefonat ermitteln wir die Hürden, die dich von deinen
                    Wunschumsätzen fernhalten ermitteln wir die Hürden,.
                  </p>
                </div>
              </div>
            </Carousel.Item>
            <Carousel.Item>
              ...
              <div className="col-md-3 col-sm-6">
                <div className=" box_card text-center">
                  ...
                  <p className=" fs_xsm mt-2 mb-0 fw_regular ff_mont text_primary_color">
                    Ein ausgewählter Strategieberater entwickelt in 60 Minuten
                    mit dir einen individuellen Plan, um deinen Markt erobern zu
                    können.
                  </p>
                </div>
              </div>
          ...
          <div className="d-flex mt-md-5 mt-3 justify-content-center">
